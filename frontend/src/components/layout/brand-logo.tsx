...
export function BrandLogo({ className, title = 'ServerManager' }: { className?: string; title?: string }) {
  return (
    <svg
      viewBox='0 0 40 40'
      role='img'
    ...
    >
      <defs>
        <linearGradient id='servermanager-logo-bg' x1='5' y1='3' x2='35' y2='37' gradientUnits='userSpaceOnUse'>
          <stop stopColor='#38BDF8' />
          <stop offset='0.48' stopColor='#6366F1' />
          <stop offset='1' stopColor='#A855F7' />
        </linearGradient>
        <linearGradient id='servermanager-logo-line' x1='11' y1='11' x2='30' y2='30' gradientUnits='userSpaceOnUse'>
          <stop stopColor='#FFFFFF' />
          <stop offset='1' stopColor='#DBEAFE' />
        </linearGradient>
      </defs>
      <rect width='40' height='40' rx='12' fill='url(#servermanager-logo-bg)' />
      ...
      <path d='M15 16h10M15 20h10M15 24h6.5' stroke='url(#servermanager-logo-line)' strokeWidth='2' strokeLinecap='round' />
