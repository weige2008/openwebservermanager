...
- Cổng Agent: nút từ xa chủ động kết nối tới máy chủ quản lý và chuyển tiếp SSH/SFTP nội bộ qua luồng TCP hai chiều đã xác thực và kiểm toán; phiên đã định tuyến không âm thầm quay về kết nối trực tiếp.
